                ...
                <div className="w-full h-full">
                    <div className="bg-blackMain mr-2 p-8 w-full h-full text-white mt-10">
                        <div className="w-full h-full max-w-full-xl mt-2 bg-blackMainmax-w-sm bg-gray-800 rounded-lg shadow-lg overflow-hidden">
                            <div className="p-6">
                                <h1 className="text-2xl font-bold text-white mb-2">{songData.title}</h1>
                                <p className="text-sm text-gray-400 mb-12">
                                    <Link to="/Perfil" className="hover:text-white">{songData.interpreters}</Link> • {songData.createdAt}
                                </p>
                                ...
                                <p className="text-xs text-gray-400 mb-2">{songData.releaseDate}</p>

        ...
        <div className="flex flex-col-2">
            ...
            <div className="w-full h-full mt-[6rem]">
                ...
                <div className="flex justify-center w-full">
                    <img className="w-64" src={logoSodaie} alt="" />
                </div>
                ...
                <div className='flex flex-col items-center w-full h-full mt-4 gap-4 mb-96'>
                    ...
                    <div className='flex'>
                        <SelectedButton/>
                        <input type="text" className='outline-none text-black px-4 w-[20rem] h-[3rem] ' placeholder='Luis Segura' />
                    </div>

                    <div className='flex'>
                        <SelectedButton/>
                        <input type="text" className='outline-none text-black px-4 w-[20rem] h-[3rem]' placeholder='Bruno Mars' />
                    </div>

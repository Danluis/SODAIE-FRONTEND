                ...
                <div className="w-full h-full">
                    <div className="bg-blackMain mr-2 p-8 w-full h-full">
                        <div className="flex items-center justify-around">
                            ...
                            <ChooseRegisterCard Icon={FaUserEdit} title={'Creador de música'} NameUser={'creador'} subTitle={'Escribo, compongo, arreglo o administro un repertorio musical.'} img={'https://cdn.pixabay.com/photo/2024/04/17/16/33/ai-generated-8702438_960_720.png'}/>
                        </div>
                        <Footer />
                    </div>
                </div>

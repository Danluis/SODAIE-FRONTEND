...
export default function FormGeneralInfo() {
    ...
    useEffect(() => {
        if (redirect) navigate('/FormPersonalInfoUser');
    }, [redirect, navigate]);
                        ...
                        <div className="flex gap-16 flex-col-2 justify-center">
                            <FormProvider {...methods}>
                                <form onSubmit={onSubmit} className="mt-10">
                                    ...
                                    <FormInput name="nickname" text="Usuario" placeholder="Usuario" />
                                    ...
                                    <div className="flex justify-between gap-10 mt-6">
                                        ...
                                        <Link to="/FormPersonalInfoUser" className="text-center w-1/4 bg-semiBlack text-semiWhite px-4 py-3 rounded-xl font-semibold hover:bg-slate-900 transition-transform transform hover:scale-105">Omitir</Link>
                                    </div>
